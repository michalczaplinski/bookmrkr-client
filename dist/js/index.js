...
$(document).ready(function () {
    ...
    $("#login").click(function () {
        ...
        var login = $.post("api/auth/login/", { "username": username, "password": password }).done(function (data) {
